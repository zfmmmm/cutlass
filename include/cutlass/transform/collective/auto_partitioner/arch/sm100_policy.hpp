...
struct IsSm100TensorOpElement
    : std::integral_constant<bool, std::is_same<Element, float>::value ||
...
struct Sm100SimtRoleA : Sm100SimtMainloopRole<Element, GmemStride, cute::size<0>(TileShape_MNK{}),
                                              cute::size<2>(TileShape_MNK{}), ThreadCount>
{
};

template <class Element, class GmemStride, class TileShape_MNK, int ThreadCount>
struct Sm100SimtRoleB : Sm100SimtMainloopRole<Element, GmemStride, cute::size<1>(TileShape_MNK{}),
                                              cute::size<2>(TileShape_MNK{}), ThreadCount>
{
};
/**
...
template <class Element, class GmemStride, class TileShape_MNK, int ThreadCount> struct Sm100SimtRoleC
{
    ...
    using TiledMma =
        decltype(cutlass::gemm::collective::detail::sm100_make_simt_f32_tiled_mma<GmemStride, 1, GmemStride, 1,
...
template <class Element, class GmemStride, class TileShape_MNK, int ThreadCount, int GmemAlignmentBytes,
          class ClusterShape>
struct Sm100TensorOpMainloopRole<Element, GmemStride, TileShape_MNK, ThreadCount, GmemAlignmentBytes, ClusterShape,
                                 true>
{
    using ElementMma =
    ...
    using TiledMma =
        decltype(cutlass::gemm::collective::detail::sm100_make_trivial_tiled_mma<
                 ElementMma, ElementMma, Accumulator, TileShape_MNK, ClusterShape, Major,
    ...
    using SmemLayoutAtom =
        decltype(cutlass::gemm::collective::detail::sm100_smem_selector<Major, SmemAllocElement, cute::Int<BlkM>,
    ...
    using GmemToSmemTmaCopy = decltype(cute::make_tma_atom_A_sm100(
        GmemTiledCopyTmaOperation{},
        cute::make_tensor(cute::make_gmem_ptr(static_cast<Element *>(nullptr)),
                          cute::make_shape(cute::Int<BlkM>{}, cute::Int<BlkK>{}), GmemStride{}),
        SmemLayout{}, TileShape_MNK{}, TiledMma{}, ClusterLayoutVMNK{}));
    ...
    using GmemToSmemCpAsyncCopy =
        decltype(cutlass::gemm::collective::detail::make_simt_gmem_tiled_copy<
                 cute::Copy_Atom<cute::SM80_CP_ASYNC_CACHEALWAYS_ZFILL<CpAsyncAlignmentType>, Element>, ThreadCount,
                 GmemToSmemAlignmentElements, GmemStride, cute::Int<BlkM>, cute::Int<BlkK>>());
                                 ...
                                 false>
{
    ...
    using TiledMma = decltype(cutlass::gemm::collective::detail::sm100_make_trivial_tiled_mma<
                              ElementMma, ElementMma, Accumulator, TileShape_MNK, ClusterShape,
                              cutlass::gemm::collective::detail::tag_to_umma_major_A<GmemStride>(), Major,
                              cutlass::gemm::collective::KernelScheduleAuto>());

    using SmemLayoutAtom =
        decltype(cutlass::gemm::collective::detail::sm100_smem_selector<Major, SmemAllocElement, cute::Int<BlkN>,
                                                                        cute::Int<BlkK>>());
    using MmaShapeB =
    ...
    using GmemToSmemTmaCopy = decltype(cute::make_tma_atom_B_sm100(
        GmemTiledCopyTmaOperation{},
        cute::make_tensor(cute::make_gmem_ptr(static_cast<Element *>(nullptr)),
                          cute::make_shape(cute::Int<BlkN>{}, cute::Int<BlkK>{}), GmemStride{}),
        SmemLayout{}, TileShape_MNK{}, TiledMma{}, ClusterLayoutVMNK{}));
    ...
    using GmemToSmemCpAsyncCopy =
        decltype(cutlass::gemm::collective::detail::make_simt_gmem_tiled_copy<
                 cute::Copy_Atom<cute::SM80_CP_ASYNC_CACHEALWAYS_ZFILL<CpAsyncAlignmentType>, Element>, ThreadCount,
                 GmemToSmemAlignmentElements, GmemStride, cute::Int<BlkN>, cute::Int<BlkK>>());
...
template <class Element, class GmemStride, class TileShape_MNK, int ThreadCount, int GmemAlignmentBytes,
          class ClusterShape>
struct Sm100TensorOpRoleB : Sm100TensorOpMainloopRole<Element, GmemStride, TileShape_MNK, ThreadCount,
...
struct Sm100TensorOpRoleC
{
    ...
    using TiledMmaFor = decltype(cutlass::gemm::collective::detail::sm100_make_trivial_tiled_mma<
                                 ElementMma, ElementMma, Accumulator, TileShape_MNK, ClusterShape_MNK, MajorA, MajorB,
                                 cutlass::gemm::collective::KernelScheduleAuto>());
...
struct AutoPartitioner<cutlass::arch::Sm100, cutlass::arch::OpClassSimt, Element, GmemStride, TileShape_MNK,
...
template <typename Element, typename GmemStride, typename TileShape_MNK, int ThreadCount, typename ElementC,
          int GmemAlignmentA, int GmemAlignmentB, int GmemAlignmentC, typename ClusterShape_MNK>
struct AutoPartitioner<cutlass::arch::Sm100, cutlass::arch::OpClassTensorOp, Element, GmemStride, TileShape_MNK,
                       ThreadCount, ElementC, GmemAlignmentA, GmemAlignmentB, GmemAlignmentC, ClusterShape_MNK,
