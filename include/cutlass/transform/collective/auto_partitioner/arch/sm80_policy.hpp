                       ...
                       cute::enable_if_t<true>>
{
    ...
    struct RoleA
    {
        ...
        using CpAsyncAtom =
            cute::Copy_Atom<cute::SM80_CP_ASYNC_CACHEALWAYS<cute::uint_byte_t<AlignmentElements * sizeof(Element)>>,
                            Element>;

        using GmemToSmemCopy =
            decltype(cutlass::gemm::collective::detail::make_simt_gmem_tiled_copy<CpAsyncAtom,
                                                                                  ThreadCount,
                                                                                  AlignmentElements,
                                                                                  GmemStride,
                                                                                  cute::Int<BlkM_val>,
